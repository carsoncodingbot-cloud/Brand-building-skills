      ...
      <section className="bg-white py-16 sm:py-20">
        <div className="container-x">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {posts.map((p) => (
              <article key={p.slug} className="flex h-full flex-col rounded-2xl border border-ice-100 bg-gradient-to-b from-white to-ice-50 p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-md">
