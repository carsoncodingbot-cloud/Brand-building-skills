...
export default async function BlogPost({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <>
        ...
        <div className="container-x grid gap-12 lg:grid-cols-[1.6fr_1fr]">
          ...
          <aside className="lg:sticky lg:top-28 lg:self-start">
            <div className="overflow-hidden rounded-3xl bg-gradient-to-b from-navy-800 to-[#001a36] p-7 text-white shadow-[0_30px_60px_-24px_rgba(0,43,88,0.6)] ring-1 ring-white/10">
              ...
              <p className="mt-2 text-sm text-white/80">Free exact-price estimates, in writing, before any work begins. 24/7 across greater San Antonio.</p>
      ...
      <CtaBand
        title="Need eyes on your system?"
        text="Straight answers and your exact price in writing — before a single tool comes out."
      />
    </>
  );
}
